...
\name{Sotiris}{Kavvouras}
\position{Software Engineer{\enskip\cdotp\enskip}Backend \& Cloud Specialist{\enskip\cdotp\enskip}Consultant}
%\address{YOUR ADDRESS}

\mobile{+30 695 668 8252}
\email{sotos.kavvouras@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{themagicalmammal.vercel.app} 
\github{SotirisKavv}
\linkedin{sotiris-kavvouras}
% \gitlab{gitlab-id}
